...
function Item({id,title,desc,cov,ico,enr,chk}:{ id
 :number,title:string,desc:string,cov:string,ico:string,
 enr:boolean,chk:boolean}){
 console.log("Key:",id);
...
<div className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={{backgroundImage: `url('${cov}')`,backgroundPosition: 'center' }} title={title}>
</div>
<div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
 ...
 <div className="flex items-center">
   ...
   <div className="text-sm">
     <p className="text-gray-900 leading-none">Paholl yangyuen</p>
